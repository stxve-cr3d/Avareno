    ...
    with db() as conn:
        ...
        conn.execute(
            ...
            (
                ...
                item_id,
                "RECEIPT",
                "kaffeemaschine-rechnung.pdf",
                "/uploads/sample-receipt.pdf",
                "application/pdf",
                "MediaMarkt Kaffeemaschine EP2231/40 349 EUR",
                '{"merchant":"MediaMarkt","manufacturer":"Philips","model":"EP2231/40","price":349}',
                now,
                now,
            ),
        )
        conn.execute(
            ...
            (
                ...
                "Brühgruppe verkalkt, Maschine meldete Fehler.",
                "Entkalkt und Dichtung getauscht.",
                19.99,
                "RESOLVED",
                now,
                now,
        ...
        conn.execute(
            ...
            (
                ...
                user_id,
                item_id,
                "Garantie der Kaffeemaschine prüfen",
        ...
        conn.execute(
            ...
            (
                ...
                item_id,
                "Warranty Saver",
                "Die Garantie der Kaffeemaschine endet bald.",
                "2027-08-14T09:00:00+00:00",
                "ACTIVE",
                now,
                now,
