...
4. Privacy And Trust
   - Auth, export, executed account deletion, connector disconnect and document
     deletion must stay visible and honest.
...
- Target-project account deletion/export verification and backup deletion
  policy beyond the local foundation.
